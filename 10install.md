...
# DRAFT (This document is still being edited.)

Welcome to the installation guide for BigBlueButton version 1.0.0.  BigBlueButton is an open source web conferencing system for on-line learning.  For an overview what new in this release, see [overview](/overview/10overview.html).
...
```
$ echo "deb http://ubuntu.bigbluebutton.org/to-be-added/ bigbluebutton-trusty main" | sudo tee /etc/apt/sources.list.d/bigbluebutton.list
```
...
If already have a BigBlueButton 0.9.1 server, these instructions will **not** upgrade your server.  To install BigBlueButton 0.9, you need to install on a clean installation of Ubuntu 14.04 64-bit and follow the steps previous in this document.
...
<pre><code>        &lt;h2&gt;You need Flash installed and enabled in order to use the Flash client.&lt;/h2&gt;
        &lt;br/&gt;
        &lt;div style="width:50%; margin-left: auto; margin-right: auto; "&gt;
          &lt;a href="http://www.adobe.com/go/getflashplayer"&gt;
            &lt;img src="<span style="color:#980000;font-weight:bold">https</span>://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player" /&gt;
          &lt;/a&gt;</code></pre>
