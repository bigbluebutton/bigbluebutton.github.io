...
If you want to interactively test your BigBlueButton server (as opposed to using an [3rd party integration](https://bigbluebutton.org/integrations/)), you can install a set of API demos.
...
<pre><code>    &lt;condition field=&quot;${sip_via_protocol}&quot; expression=&quot;^ws<span style="color:#980000;font-weight:bold">s?</span>$&quot; break=&quot;on-false&quot;&gt;
</code></pre>
