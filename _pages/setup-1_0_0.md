---
layout: page
title: "Setup Development Environment 1.0.0"
category: dev
...
Before you can start developing on BigBlueButton, you to [install BigBlueButton 1.0.0](/install/install.html) and ensure it's working correctly (i.e. you had no errors during install).
