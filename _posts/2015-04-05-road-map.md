...
Since the summer of 2009 we've had twelve releases: 0.50, 0.60, 0.61, 0.62, 0.63, 0.64, 0.70, 0.71, 0.71a, 0.80, 0.81, and 0.9.1 -- each release improving on the previous, each reflecting the desire by the core developers  to build a solid product.
...
## Whiteboard
Support ability to move/edit whiteboard objects ([2351](https://github.com/bigbluebutton/bigbluebutton/issues/2351)).  Support multi-user editing of whiteboard objects ([2055](https://github.com/bigbluebutton/bigbluebutton/issues/2055)).

Support keyboard input of text and symbols ([1346](https://github.com/bigbluebutton/bigbluebutton/issues/1346)).
...
[2943](https://github.com/bigbluebutton/bigbluebutton/issues/2943)
...
Create an HTML5 BigBlueButton client (see [1605)](https://github.com/bigbluebutton/bigbluebutton/issues/1605) and [HTML5 Client Specification](https://code.google.com/p/bigbluebutton/wiki/HTML5).
