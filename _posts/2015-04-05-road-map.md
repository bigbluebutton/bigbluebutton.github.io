...
The latest relesae is [BigBlueButton 2.2-beta](/2.2/install.html), which provides a full HTML5 client for desktop, laptop, chromebook, and mobile (Android 6.0+ and iOS 12.2+).
