...
## Polling  
Create a polling module that enables the presenter to easily do on-the-fly polls to increase student engagement.  Give the presenter the option of having the results recorded (see [1586]https://github.com/bigbluebutton/bigbluebutton/issues/1586)).
