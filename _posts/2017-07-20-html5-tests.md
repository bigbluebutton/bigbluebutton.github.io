...
```sh
$ curl -L https://github.com/mozilla/geckodriver/releases/download/v0.19.0/geckodriver-v0.19.0-linux64.tar.gz | tar xz
```
...
```sh
$ wget sourceforge.net/projects/ubuntuzilla/files/mozilla/apt/pool/main/f/firefox-mozilla-build/firefox-mozilla-build_56.0.2-0ubuntu1_amd64.deb
$ sudo dpkg -i firefox-mozilla-build_56.0.2-0ubuntu1_amd64.deb
```
...
```sh
$ xvfb-run java -jar selenium-server-standalone-3.5.3.jar
```
...
```sh
$ xvfb-run -a java -jar selenium-server-standalone-3.5.3.jar
```
