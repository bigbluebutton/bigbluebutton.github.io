...
For full details on what is new in BigBlueButton 2.3-dev, see the release notes for [alpha-1](https://github.com/bigbluebutton/bigbluebutton/releases/tag/v2.3-alpha-1), [alpha-2](https://github.com/bigbluebutton/bigbluebutton/releases/tag/v2.3-alpha-2), and [alpha-3](https://github.com/bigbluebutton/bigbluebutton/releases/tag/v2.3-alpha-3).
...
For example, if the external hostname of your server was `bbb.example.com` and your e-mail address was `notice@example.com`, you can install BigBlueButton 2.3-dev with the command
