...
The notifications for viewers are unchanged

<img src="/images/23-user-notifications.png" alt="Viewer notifications" width="50%">

Moderators now get to additional notifications: raise hands and guest waiting.

<img src="/images/23-moderator-notifications.png" alt="Moderator notifications" width="50%">

For raise hands, the toast notification will stay on the screen until all students lower their hands, or the moderator clears the notification.

<img src="/images/23-two-students.png" alt="multiple notifications" width="50%">

The persistent toast message will show multiple names when more than one student raises their hand.
...
As a presenter, you can now have students provide a written response to a question. From the user's point of view, when prompted, they will see a dialog box in the lower right-hand corner.
