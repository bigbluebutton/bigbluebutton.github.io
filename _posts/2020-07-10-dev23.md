...
For raise hands, the toast notification will stay on the screen until all students lower their hands, or a moderator clears the notification.

<img src="/images/23-two-students.png" alt="multiple notifications" width="50%">

The persistent toast message will show multiple names when more than one student raises their hand, or a moderator clicks 'Lower Hands'.
...
<img src="/images/bigbluebutton-user-response.png" alt="BigBlueButton polling typed responses" width="75%">
