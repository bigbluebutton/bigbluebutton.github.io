...
BigBlueButton 2.3-alpha7 also introduced https://github.com/bigbluebutton/bigbluebutton/blob/v2.3-alpha-7/bigbluebutton-html5/deploy_to_usr_share.sh - a script with which you can deploy your [customized] bigbluebutton-html5/* code as locally running `bbb-html5` package (production mode, requiring the `poolhtml5servers` NginX rule)
