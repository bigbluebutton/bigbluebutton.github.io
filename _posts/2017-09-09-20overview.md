...
Removed two moderator capabilities in breakout rooms: demoting others to viewers or kicking out other users.   Also added the ability to restrict private chat in breakout rooms.

Also added a new property to config.xml `privateChateEnabled` to disable private chat in breakout rooms.
