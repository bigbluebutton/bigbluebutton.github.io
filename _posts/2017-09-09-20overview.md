...
~~~xml
<branding logo="logo.swf" copyright="&#169; 2017 &lt;u&gt;&lt;a href=&quot;https://dev2.bigbluebutton.org/home.html&quot; target=&quot;_blank&quot;&gt;BigBlueButton Inc.&lt;/a&gt;&lt;/u&gt; (build {0})" background="" toolbarColor="" showQuote="true"/>
~~~

You can change the parameters:

  * `logo` A logo file (swf or PNG).  Default location is `/var/www/bigbluebutton/client/logo.swf`
  * `copyright` The copyright text shown in the lower left-hand corner
  * `background` Background color for the toolbar
  * `toolbarColor` Toobar color
