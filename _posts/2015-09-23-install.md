...
** This is an older release (and not recommended).  See [latest release](/install/install.html). **
...
If you want to interactively test your BigBlueButton server (as opposed to using an [3rd party integration](http://bigbluebutton.org/integrations/)), you can install a set of API demos.
