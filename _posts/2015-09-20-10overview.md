...
The goal of this release is to increase interactivity between the teacher and students with three new features:
  ...
  * Support for Puffin mobile web browser 
...
[Puffin Browser](https://www.puffinbrowser.com/index.php) is a web browser for mobile devices that allows users to run web-based Flash appliations from within their mobile iOS or Andorid device (phone or tablet).  

Puffin version 4.6 (and greater) added the ability for users to broadcast thier webcam and microphone.  BigBlueButton 1.0 adds detecting for the Puffin web browser and, if the user is running Puffin version 4.6 (or greater), enable to the user to share their webcam and microphone in BigBlueButton.
