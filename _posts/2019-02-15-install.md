...
This document guides you through installing BigBlueButton 2.2-beta (referred hereafter as simply BigBlueButton).  For an overview of the product see the [documentation home page](/).
...
If you don't find a resolution to your issue in these docs or using Google search, then make a post to the [bigbluebutton-setup](https://bigbluebutton.org/support) mailing list.  Provide a brief description of your issue along with any relevant error messages, and include the following information:
...
```bash
$ sudo letsencrypt --webroot -w /var/www/bigbluebutton-default/ -d bigbluebutton.example.com certonly
