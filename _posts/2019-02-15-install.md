...
The `bbb-conf --check` scans some of the log files for error messages.  If you've upgraded from a previous version of BigBlueButton 2.2-beta, you'll want to re-assign the hostname/IP to BigBlueButton's configuration files on your server. 
