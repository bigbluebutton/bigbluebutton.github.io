...
Note: If you don't get a clean install and `sudo apt-get install -f` still gives you errors, stop here.  The install did not complete and going further will only make it harder to resolve the underlying issues.  See [getting help](#getting-help).
