...
See the [customizations page](/2.6/customizations.html) for things you can do to adapt BigBlueButton to your environment or enable optional features after installation.
