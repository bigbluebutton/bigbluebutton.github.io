...
| moderatorPW    | Required                | String    | The password that will be required for moderators to join the meeting or for certain administrative actions (i.e. ending a meeting). This is optional, and if not supplied, BigBlueButton will assign a random password. |
