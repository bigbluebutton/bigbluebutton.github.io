...
| attendeePW  | Required             | String  | The password that will be required for attendees to join the meeting. |
| moderatorPW | Required             | String  | The password that will be required for moderators to join the meeting or for certain administrative actions (i.e. ending a meeting). |
