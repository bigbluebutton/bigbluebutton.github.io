...
BigBlueButton is a virtual classroom designed to help teachers effectively engage students for online learning.  BigBlueButton is built by teachers, for teachers -- meaning that we, the core developers, spend a lot of time listening to teachers (and students) for their input on improving BigBlueButton for them so they can hold effective virtual classes.

In our research, from the teacher's perspective, there are four key foundations of holding a successful virtual class:
...
We describe the improvements of this release in the context of these pillars.  Here's a breakdown of what's new in 2.5.
...
<img src="/images/25-see-cursor-lock-setting.gif" alt="Point to spain" style="max-width: 60%; height: auto;"/>
<br /><br />
