...
Under the hood, BigBlueButton 2.5 installs on Ubuntu 20.04 64-bit.  Moving to a newer version has enabled us to upgrade to use Java 11 and Meteor 2.5 as default.

For full details on what is new in BigBlueButton 2.5, see the release notes. Recent releases:

- [alpha-4](https://github.com/bigbluebutton/bigbluebutton/releases/tag/v2.5-alpha-5)
...
To install 2.5, use [bbb-install-2.5.sh](https://github.com/bigbluebutton/bbb-install/blob/master/bbb-install-2.5.sh). 
