...
- Note that BigBlueButton 2.6 is already developen.
  You might want to follow the [2.6 development guide](/2.6/dev.html) instead.

This document gives you an overview of how to set up a development environment for BigBlueButton 2.5.

# Before you begin

You first need to set up a BigBlueButton 2.5 server. See the instructions at [Install BigBlueButton 2.5](/2.5/install.html).
...
Before you can start developing on BigBlueButton, you must install BigBlueButton 2.5 (see [installation steps](/2.5/install.html)) and ensure it's working correctly. Make sure there were no errors during the installation and that you can join a session successfully.
