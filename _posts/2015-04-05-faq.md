...
By saying there is _some_ security mechanisms BigBlueButton, does this mean BigBlueButton offers secure collaboration?  No. It does mean there are opportunities to make BigBlueButton more secure. 

If you are interested in setting up a more secure BigBlueButton server for your organization, contact any of the companies that provide commercial support for BigBlueButton. See [http://bigbluebutton.org/support](http://bigbluebutton.org/support).  
