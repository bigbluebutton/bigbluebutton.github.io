...
[BigBlueButton 1.1-beta](/1.1/install.html) comes with GreenLight, a simple front-end application that let's users quickly and easily create meetings, invite others, join meetings, and manage the recordings.

![greenlight-start](/images/gl-start.png)

For more information see [Installing GreenLight](/1.1/green-light.html).
