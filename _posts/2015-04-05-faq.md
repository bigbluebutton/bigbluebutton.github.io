...
When a new meeting starts, BigBlueButton displays a default presentation.  The default presentation is located in

```
/var/www/bigbluebutton-default/default.pdf
```

Alternatively, you can point BigBlueButton to use a different location for the default.pdf by editing `/var/lib/tomcat7/webapps/bigbluebutton/WEB-INF/classes/bigbluebutton.properties` and changing the line
