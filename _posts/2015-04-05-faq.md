...
### Will my animations and videos in PowerPoint convert when uploading to BigBlueButton

When you upload a PowerPoint document, BigBlueButton will convert ito to PDF (using LibreOffice) and then finally to scalable vector graphics (SVG) for displahy within the client.  
...
If you want to share a YouTube or Vimeo document, use the built-in Share Video (under the '+' button for the current presenter).
