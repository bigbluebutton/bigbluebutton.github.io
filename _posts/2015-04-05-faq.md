...
As of Chrome 42, Google has disabled launching of Java Applets by default.  This is part of the planned removal of support for launching external NPAPI plugins (see [Java and Google Chrome](https://java.com/en/download/faq/chrome.xml)).

You can re-enable support for launching BigBlueButton's desktop sharing applet using the following steps:
...
You should now be able to start desktop sharing again in Java.  

This workaround will work until September 2015, whereupon Google will completely remove support for Chrome launching Java applets.  Going forward, we recommend using FireFox for desktop sharing as it retains the ability for launching Java applets.
