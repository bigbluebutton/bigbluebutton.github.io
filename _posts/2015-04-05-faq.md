...
Done.  BigBlueButton runs within the Chrome browser (no app to install) on Android 6.0+.  You can test this at [https://demo.bigbluebutton.org/](https://demo.bigbluebutton.org/).

### iOS

Done.  BigBlueButton runs within the Safari browser (no app to install) on iOS 12.2+.  You can test this at [https://demo.bigbluebutton.org/](https://demo.bigbluebutton.org/).
