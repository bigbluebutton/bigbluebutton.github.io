...
Welcome to the installation guide for BigBlueButton 1.0-beta (referred hereafter as BigBlueButton 1.0).  BigBlueButton is an open source web conferencing system for on-line learning.  For an overview what new in this release, see [overview](/1.0/10overview.html).
