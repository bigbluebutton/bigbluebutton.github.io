...
You need to make sure that the dialplan will accept the incoming secure websocket. Open the file `/opt/freeswitch/conf/dialplan/public/bbb_webrtc.xml` and locate
 the line
