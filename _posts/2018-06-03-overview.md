...
![overview](/images/Flash-Client.png)
...
![audio](/images/Audio-Modal.png){:height="264px" width="659px"}
...
![buttons](/images/Flash-Top-Controls.png)
...
![20-users](/images/Flash-UsersList.png)
...
![start-recording](/images/Flash-Start-Recording.png)
...
![notify-recording](/images/Flash-Record-Notification.png)
...
![Polling Question](/images/Flash-Polling-Question.png)
...
![Polling Pre-configure](/images/Flash-Polling-PreConfigure.png)
...
![Polling Response](/images/Flash-Poll-Response.png)
...
![Polling Smart](/images/Flash-Smart-Poll.png)
...
![Set Emoji Status](/images/Flash-Set-Emoji.png)
...
![Open ScreenShare Options](/images/Flash-Open-ScreenShare.png)
...
![ScreenShare Java Guide](/images/Flash-SS-Java.png)
...
![Open ScreenShare Options](/images/Java-run-confirm.png)
...
![ScreenShare Region](/images/Flash-SS-Region.png)
...
![Captions Layout Select](/images/Flash-CC-Layout.png)

and then selects the language to provide captions

![Captions Language](/images/Flash-CC-Lang.png)
...
![Captions Ownership](/images/Flash-CC-Ownership.png)
...
![Captions Playback](/images/ClosedCaption-Playback.png)
...
![Breakout Room Start](/images/Flash-BR-Start.png)
...
![Breakout Room Config](/images/Flash-BR-Configure.png)
...
![Join Breakout](/images/Flash-Join-BR.png)
...
![Breakout Invite](/images/Join-BreakoutRoom.png)
...
![Breakout Timer](/images/Flash-BR-Time.png)
...
![Breakout Invite](/images/Flash-Monitor-Breakout.png)
...
![enable-download](/images/Flash-UploadFiles.png){:height="443px" width="826px"}
...
![download-button](/images/Flash-Download-Pres.png){:height="443px" width="826px"}
...
![smooth](/images/Flash-Line-Smoothing.png){:height="443px" width="826px"}
...
![user-promote](/images/Flash-Promote.png){:height="205px" width="475px"} ![user-demote](/images/Flash-Demote.png){:height="205px" width="475px"}
...
![lock-viewer-features](/images/Flash-Lock-Viewers.png){:height="443px" width="826px"}
...
![chat-options](/images/Flash-Chat-Options.png){:height="643px" width="279px"}
...
![end-logout](/images/Flash-End-Meeting.png){:height="92px" width="419px"}
...
![full-screen](/images/Flash-fullscreenBtn.png){:height="85px" width="542px"}

 
When users click the Full Screen button, the browser displays a confirmation dialog on the switch to full screen mode.

![full-screen-exit](/images/Chrome-FullScreen-Confirm.png)
...
![shared-notes-show](/images/Flash-Show-SharedNotes.png){:height="502px" width="1477px"}
...
![shared-notes-clear](/images/Flash-Clear-SharedNotes.png)
...
![shared-notes-create](/images/Flash-Create-SharedNote.png)
...
![shared-notes-format](/images/Flash-SharedNotes-TextFormat.png)

### Download Shared Notes

Users can also download the content of the shared notes as plain text or HTML.

![shared-notes-download](/images/Flash-Save-SharedNotes.png)
...
![mu-button](/images/Flash-Multi-Whiteboard.png){:height="443px" width="826px"}
...
![logo](/images/Flash-Branding.png)
...
![mu-over](/images/Flash-Manage-Breakout.png)
...
![rate](/images/Flash-Feedback.png)
...
![webcams only for moderators](/images/Flash-Lock-Cams.png)
