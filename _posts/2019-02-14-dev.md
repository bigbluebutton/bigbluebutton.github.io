...
In the next step we will make a copy of the current production direcotry for `bbb-web` 
...
And now, we need to make sure the copied files have the right user ownserhip.
