...
# BigBlueButton 1.1-RC

Welcome to BigBlueButton 1.1-RC, the latest release for BigBlueButton, an open source web conferencing system for online leanring.

This document covers the new capabilities in BigBlueButton 1.1-RC:
...
At this point, the moderator can begin typing text (or using a stenograph machine to inject text) into the text area.
