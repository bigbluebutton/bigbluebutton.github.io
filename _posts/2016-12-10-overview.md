...
We upgraded the version of FreeSWITCH to 1.6.11. This brings support for forward error correction in WebRTC aduio for even better audio in lower bandwidth conditions.

## Red5

This release is build upon red5 1.0.8-M13.  Thanks to the red5 team for responding to our bug reports and helping us to fix some edge cases in red5.