...
These steps assume you have already upgraded from 1.1 to 2.0-beta and want to upgrade to a later build of 2.0-beta.  To install the latest build of BigBlueButton 2.0-beta, enter the following commands:
