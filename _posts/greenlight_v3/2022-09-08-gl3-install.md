...
If docker dependencies are installed correctly, running the following commands should output the installed version and their status:
```bash
sudo docker version
...
The output should be `CREATE DATABASE`.
