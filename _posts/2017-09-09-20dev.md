...
Start grails and tell to listen on port 8888
...
For example:
In the file `/home/ubuntu/dev/bigbluebutton/bbb-common-message/build.sbt`
...
~~~
cd /home/ubuntu/dev/bigbluebutton/bbb-common-message
sbt clean
sbt compile
~~~
...
Change the bbb-common-messages version required in the components akka-bbb-apps and akka-bbb-fsesl. In the files `/home/ubuntu/dev/bigbluebutton/akka-bbb-apps/build.sbt` and `/home/ubuntu/dev/bigbluebutton/akka-bbb-fsesl/build.sbt` substitute the line `"org.bigbluebutton" % "bbb-common-message" % "0.0.18"` with `"org.bigbluebutton" % "bbb-common-message" % "0.0.19-SNAPSHOT"`.
