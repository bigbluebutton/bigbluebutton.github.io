...
This section covers the enhancements to BigBlueButton’s core. There are quite a few things on our [tracking list in GitHub](https://github.com/bigbluebutton/bigbluebutton/issues?q=is%3Aissue+is%3Aopen+label%3A%22status%3A+accepted%22) But here are some:
...
Allow users to individually close webcams.

## Links in slides not clickable

When uploading slides with clickable links, they are not clickable in the HTML5 client.
