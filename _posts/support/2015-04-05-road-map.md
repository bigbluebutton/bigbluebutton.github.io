...
The latest release is [BigBlueButton 2.2](/install/install.html), which provides a full HTML5 client for desktop, laptop, chromebook, and mobile (Android 6.0+ and iOS 12.2+).
