...
<span style="color:red;font-weight: bold;">Paste the contents of your key file here</span>
END
...
<span style="color:red;font-weight: bold;">Paste (in order) the contents of the following files:
...
server {
  ...
  listen 80;
  <span style="color:red;font-weight: bold;">listen 443 ssl;
...
<pre>
  ...
  <span style="color:red;font-weight: bold;">&lt;param name="wss-binding" value=":7443"/&gt;</span>
</code>
</pre>
...
<pre>
  <code>
location /ws {
  proxy_pass <span style="color:red;font-weight: bold;">https</span>://203.0.113.3:<span style="color:red;font-weight: bold;">7443</span>;
...
function createUAWithStuns(username, server, callback, stunsConfig, makeCallFunc) {
    ...
    var configuration = {
        ...
        wsServers: '<span style="color:red;font-weight: bold;">wss</span>://' + server + '/ws',
...
bigbluebutton.web.serverURL=<span style="color:red;font-weight: bold;">https</span>://bigbluebutton.example.com
</code>
</pre>
