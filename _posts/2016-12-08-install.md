...
Next, eit the file `/usr/share/red5/webapps/screenshare/WEB-INF/screenshare.properties` and update the property `jnlpUrl` and `jnlpFile` to https:
...
~~~
$ letsencrypt --webroot -w /var/www/bigbluebutton-default/ -d yourserver.example.com certonly
