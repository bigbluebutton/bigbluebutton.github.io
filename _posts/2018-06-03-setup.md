...
You'll need to have a working BigBlueButton 2.0 server before you can setup a development environment (see [installation steps](/1.1/install.html)).
...
Tell grails to listen on port 8989
