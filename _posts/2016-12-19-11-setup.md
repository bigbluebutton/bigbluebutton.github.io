...
You'll need to have a working BigBlueButton 1.1-beta server before you can setup a development environment (see [installation steps](/1.1/install.html)).
...
Read the README file in `bbb-screenshare` directory.
