...
You'll need to have a working BigBlueButton 1.0 server before you can setup a development environment (see [installation steps](/1.0/install.html)).
...
Before you can start developing on BigBlueButton, you must install BigBlueButton 1.0 (see [installation steps](/1.0/install.html)) and ensure it's working correctly. Make sure there were no errors during the installation and that you can join a session successfully.
