...
Note that individual configuration settings are overridden with their values (if defined) from file `/usr/share/bigbluebutton/nginx/bbb-html5.nginx` (if the file exists).
