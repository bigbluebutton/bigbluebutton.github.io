...
**_Note_** These features below are experimental and incomplete and should *not* be used for a production server.  They are primarily included for developers testing new capabilities that many appear in subsequent releases to 2.4.
