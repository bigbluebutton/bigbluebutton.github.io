...
You can follow the same instructions as in [development for 2.3](/2.3/dev.html) at this point, just make sure to use the 2.4 repository for packages mentioned above, `bionic-24-dev`, and pull from GitHub branch `v2.4.x-release` [from the BigBlueButton's repository](https://github.com/bigbluebutton/bigbluebutton/branches)
